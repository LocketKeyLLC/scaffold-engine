...
async def test_sweep_expired_deletes_and_returns_titles():
    ...
    # Delete expression should use quoted IDs
    args, _ = fake_col.delete.call_args
    assert 'entry_id in [' in args[0] if args else fake_col.delete.call_args.kwargs.get("expr", "")
