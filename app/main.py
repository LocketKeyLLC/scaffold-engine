...
async def health():
    ...
    async def _check_redis():
        ...
        try:
            ...
            return {"status": "up", "keys": key_count}, cache_stats, verifier_cache_stats
        except Exception:
            return {"status": "down", "keys": 0}, cache_stats, verifier_cache_stats
    ...
    redis_info, cache_stats, verifier_cache_stats = redis_pair
