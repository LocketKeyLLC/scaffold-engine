...
# here so every existing caller, test and source-scanning gate keeps working
# (the §17.856 pattern, which is what made that split survivable).
from app.modules.assist_draft import (  # noqa: E402,F401
    _ACCEPTANCE_RE,
    _BLOCKING_VERBS,
    _CONSUMING_MARKERS,
    _CRITERIA_STOPWORDS,
    ...
    _GUEST_LOOKBEHIND,
    _HEREDOC_START_RE,
    _HISTORY_EVENT_TRIGGER,
    _IN_GUEST_MARKER_RE,
    _LIFECYCLE_RE,
    _LOCAL_HOST_RE,
    _LOCATION_BANNER_RE,
    _NEXT_ACTION_SECTION_RE,
    _NONTERMINATING_FIXES,
    _NO_ACTION_RE,
    _PAGER_FIXES,
    _PASTE_SAFE_BYTES,
    _PLAN_MUTATION_CLAIM_RE,
    _PRIVILEGED_GUEST_RE,
    _READONLY_PAIRS,
    _READONLY_VERBS,
    _REMOTE_TARGET_RE,
    _REPL_VERBS,
    _ROOT_HOST_BANNER_RE,
    _ROOT_SHELL_RE,
    _RUNNER_PREFIX_RE,
    _STEP_ACTIONS,
    _SUDO_IN_CMD_RE,
    ...
    _command_lines_only,
    _criteria_terms,
    _dquote_continuation_lines,
    _effective_verb,
    _escape_expansions,
    _heredoc_write_parts,
    _history_scannable_lines,
    _is_lifecycle_command,
    _is_readonly_command,
    _kind_word,
    _line_has_history_event,
    _normalized_commands,
    _primary_action_corpus,
    _repeats_in_primary_action,
    _strip_sudo_in_fences,
    _text_without_heredoc_bodies,
    _url_skeleton,
    _verify_command_for,
    banned_values_warning,
    claims_plan_mutation,
    concludes_no_action_required,
    dedupe_repeated_file_writes,
    extract_acceptance_criteria,
    extract_done_criterion,
    find_banned_values,
    find_goal_drift,
    find_guess_before_look,
    find_history_expansion_hazards,
    find_nonterminating_commands,
    find_novel_urls,
    find_presupposed_completion,
    find_repeated_failed,
    find_resource_kind_violations,
    ...
    resource_kind_warning,
    resource_kinds_from_facts,
    runs_on_another_host,
